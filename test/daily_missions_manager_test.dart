  ...
  group('DailyMissionsManager', () {
    ...
    setUpAll(() {
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
          .setMockMethodCallHandler(const MethodChannel('games_services'), (
    ...
    setUp(() async {
      ...
      testPlayer = PlayerInfo(highScore: 0, coins: 0, playerId: 'test_player');
    });
    ...
    test(
      'trackCoinCollected updates progress and correctly flags unclaimed mission',
      () async {
        await manager.init();
    ...
    test(
      'trackGamePlayed updates games and score progress correctly',
      () async {
        await manager.init();
    ...
    test(
      'claimCoinsReward correctly claims reward and calls PlayerInfo',
      () async {
        await manager.init();
    ...
    test(
      'claimScoreReward correctly claims reward and calls PlayerInfo',
      () async {
        await manager.init();
    ...
    test(
      'claimGamesReward correctly claims reward and calls PlayerInfo',
      () async {
        await manager.init();
